...
The emerging data science education research community reflects an exciting mix of scholars, disciplines, and approaches. In recent years, various conference sessions and journal issues dedicated to this topic across domains such as Computer Science, Statistics, Information and Library Sciences, Education, and the Learning Sciences.

Navigating this multidisciplinary landscape can be challenging due to its complexity and distinct publication norms and practices. For instance, researchers in Computer Science may not realize the significance of education-focused conferences like ACM SIGCSE or IEEE for sharing innovative data science research with K-12 students. Similarly, nonspecialists might struggle to identify which education journals have been particularly active in the data science education space, such as JLS, C&I, and BJET. Early childhood educators may not be aware of the excellent resources for early data literacy development available in HDSR.

These differences between fields can hinder those entering the field or seeking comprehensive literature from recognizing parallel literature(s) and identifying from the complementary insights, expertise, and methods offered by various disciplines. Different communities may adopt different definitions or conceptualizations for the same key terms, "talking past" one another, or they may create new terms for similar ideas and methods, missing opportunities for convergence and collaboration. For example, Rosenberg & Jones (2024) present caricatures of differing perspectives on what "data science education" might look like in K-12, as reflected by the different emphases of three special issues devoted to the topic that appeared in different journals.

Now, about a decade after the emergence of "data science education" as a distinct area of study, researchers are beginning to take stock of this landscape. In this report, I contribute to these efforts by mapping and analyzing the communities and literatures that form the foundations of data science education research. Leveraging bibliometric and network analytic methods, I examine the co-citation patterns of a focused collection of papers which identify "data science education" as a central focus. I identify a core collection of shared (but not-so-shared) broker references, as well as three distinctive, conceptually coherent, and somewhat isolated collections of reference works, each that corresponding to different disciplinary communities, publication venues, and student audiences. Through additional qualitative content analysis, I examine how these clusters suggest particular communities, methodologies, and topics reflected in the current literature. I also showcase areas of convergence as well as emerging divisions regarding undergraduate and K-12 data science education efforts, and between K-12 initiatives arising from different subfields.

My goal is to raise awareness of these separations and encourage deeper engagement across subcommunities to build stronger, more coherent trajectories for data science education. To facilitate this, I provide an interactive document and open-source code for readers to explore data science education literature and clusters further. I extend a community invitation to continue mapping the field together and seeking mutual understanding, if not convergence, across disciplines. To the extent that data is a part of everyone's lives, important to conside the full lifecycle of education and points of connection.
...
For this analysis, I make extensive use of the R `bibliometrix` package [@aria2017] for constructing, analyzing, and visualizing bibliographic records. I use the `dplyr` package for data handling [@wickham2023], and the `stringr` and `textTools` packages to process and compare scholarly reference records. The `DT` package [@dt:awr2024] is used to generate interactive data displays.
